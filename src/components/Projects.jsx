...
const projects = [
  ...
  },
  {
    ...
    category: 'React • Problem Solving',
    description: 'An interactive web application built to visualize how different search algorithms process data, helping to deeply understand time complexity.',
    tech: ['React.js', 'JavaScript', 'CSS', 'Algorithms'],
    color: 'barca-red',
    number: '02',
