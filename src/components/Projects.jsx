...
const projects = [
  {
    ...
    description: 'An intelligent, AI-powered learning platform that transforms raw concepts into structured study paths. Features a Gemini-powered study assistant, adaptive quizzes, and real-time Firebase progress tracking.',
    tech: ['React.js', 'Gemini AI', 'Firebase', 'Tailwind CSS v4'],
    color: 'barca-blue',
    number: '01',
  ...
  },
  {
    ...
    description: 'A dynamic short-form video platform built exclusively for football content — goals, skills, and match highlights. Delivers a TikTok-style swipe experience with personalised feeds and seamless clip discovery.',
    tech: ['React.js', 'Firebase', 'Framer Motion', 'JavaScript'],
    color: 'barca-red',
    number: '02',
