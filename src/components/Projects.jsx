...
const projects = [
  {
    ...
    description: 'A comprehensive C++ library implementing foundational array operations from scratch, focusing on memory management and algorithmic efficiency.',
    tech: ['C++', 'Algorithms', 'Pointers', 'Memory Management'],
    color: 'barca-blue',
    number: '01',
  ...
  },
  {
    ...
    category: 'C++ • Systems Design',
    description: 'A menu-driven C++ system to manage products, update stock quantities, and view inventory reports. Focuses on structures, arrays, and control flow for real-world simulation.',
    tech: ['C++', 'Structures', 'Arrays', 'Control Flow'],
    color: 'barca-red',
    number: '02',
    gradient: 'from-barca-red/20 to-transparent',
    link: 'https://github.com/saiyash07/InventoryManagementCaseStudy',
    linkText: 'View Code',
  },
  {
    id: 3,
