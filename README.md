...
```mermaid
graph TD
    A["Stage 1: Core Foundations<br>(C++ / DSA / Memory Management)"] -->|Current Focus| B["Stage 2: AI & Mathematics<br>(Python / Machine Learning Basics)"]
    B -->|Next Phase| C["Stage 3: Systems Thinking<br>(System Design / API / Databases)"]
    C -->|Long Term Goal| D["Stage 4: Intelligent Sports Analytics<br>(AI + Football Tactical Analysis)"]
    
    style A fill:#EDBB00,stroke:#101010,stroke-width:2px,color:#101010
    style B fill:#004D98,stroke:#fff,stroke-width:1px,color:#fff
    style C fill:#A50044,stroke:#fff,stroke-width:1px,color:#fff
    style D fill:#181818,stroke:#EDBB00,stroke-width:2px,color:#EDBB00
```
...
<div align="center">
  <sub>Built with 💙 ❤️ and 💛 by Saiyash Poojari</sub>
</div>
